...
# ai-pipeline-core v0.22.4 — API Reference
...
class PipelineDeployment(Generic[TOptions, TResult]):
    ...
    async def run(self, run_id: str, documents: Sequence[Document], options: TOptions, publisher: ResultPublisher | None=None, start_step: int=1, end_step: int | None=None, parent_execution_id: UUID | None=None, database: Any=None) -> TResult | None: ...
    ...
    def run_local(self, run_id: str | None, documents: Sequence[Document], options: TOptions, publisher: ResultPublisher | None=None, output_dir: Path | None=None) -> TResult | None: ...
