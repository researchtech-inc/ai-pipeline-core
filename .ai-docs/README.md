...
# ai-pipeline-core v0.20.0 — API Reference
...
def find_all(documents: Sequence[Any], doc_type: type[T]) -> list[T]: ...
    """Find all documents of the given type in a sequence."""

def find_latest(documents: Sequence[Any], doc_type: type[T]) -> T: ...
